...
export const IdeaModal = ({ idea, isOpen, onClose, onGenerate, isGenerating }: IdeaModalProps) => {
      ...
      <div className="relative glass-card w-full max-w-2xl overflow-hidden animate-in zoom-in-95 fade-in duration-300 shadow-[0_0_50px_rgba(0,0,0,0.5)] border-white/10">
        <div className="flex justify-between items-center p-6 border-b border-white/5 bg-white/[0.02]">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h2 className="font-bold text-xl tracking-tight">Post Concept Detail</h2>
                    <p className="text-[10px] text-white/40 uppercase tracking-[0.2em]">Strategic Visualization Node</p>
                </div>
            </div>
        ...
        <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                    <p className="text-[10px] font-mono text-white/20 uppercase mb-1">Tone</p>
                    <p className="text-sm font-medium">Automatic Context Sync</p>
                </div>
                <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                    <p className="text-[10px] font-mono text-white/20 uppercase mb-1">Complexity</p>
